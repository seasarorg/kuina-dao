...
public class FindVersionCommandBuilder extends
    ...
    public Command build(final Class<?> daoClass, final Method method,
        ...
        if (!equals(idAttributeDesc.getType(), parameterTypes[0])) {
            return null;
        }
        ...
        if (!equals(versionAttributeDesc.getType(), parameterTypes[1])) {
            return null;
        }
        ...
        builders[0] = createBuilder(entityClass, parameterNames[0],
                parameterTypes[0], method.getParameterAnnotations()[0]);
