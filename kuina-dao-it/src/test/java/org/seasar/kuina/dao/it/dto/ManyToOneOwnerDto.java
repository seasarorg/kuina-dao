 ...
 * @author nakamura
 */
public class ManyToOneOwnerDto {
    ...
    protected OneToManyInverse oneToManyInverse_EQ;

    protected String oneToManyInverse$name_EQ;

    protected String oneToManyInverse$subManyToOneOwners$name_EQ;
    ...
    public OneToManyInverse getOneToManyInverse_EQ() {
        return oneToManyInverse_EQ;
    }

    public void setOneToManyInverse_EQ(OneToManyInverse oneToManyInverse) {
        this.oneToManyInverse_EQ = oneToManyInverse;
    }

    public String getOneToManyInverse$name_EQ() {
        return oneToManyInverse$name_EQ;
    }

    public void setOneToManyInverse$name_EQ(String oneToManyInverse$name) {
        this.oneToManyInverse$name_EQ = oneToManyInverse$name;
    }

    public String getOneToManyInverse$subManyToOneOwners$name_EQ() {
        return oneToManyInverse$subManyToOneOwners$name_EQ;
    }
