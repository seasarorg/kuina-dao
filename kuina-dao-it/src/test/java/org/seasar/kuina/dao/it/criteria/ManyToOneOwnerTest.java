...
public class ManyToOneOwnerTest {
    ...
    public void fromOnly() throws Exception {
        List<ManyToOneOwner> list =
            select()
                .from(ManyToOneOwner.class)
                .orderby("manyToOneOwner.id")
                .getResultList(em);
        assertNotNull(list);
    ...
    public void selectIdentificationVariable() throws Exception {
        List<ManyToOneOwner> list =
            select("manyToOneOwner").from(ManyToOneOwner.class).orderby(
    ...
    public void selectSpecifiedStates() throws Exception {
        List<Object[]> list =
            select("m.id", "m.name").from(ManyToOneOwner.class, "m").orderby(
    ...
    public void crossJoin() throws Exception {
        List<Object[]> list =
            select()
                .from(ManyToOneOwner.class, OneToManyInverse.class)
                .orderby("manyToOneOwner.id", "oneToManyInverse.id")
                .getResultList(em);
        assertNotNull(list);
        assertEquals(180, list.size());
        assertEquals("simagoro", ManyToOneOwner.class
            .cast(list.get(0)[0])
            .getName());
        assertEquals("Business", OneToManyInverse.class
            .cast(list.get(0)[1])
            .getName());
        assertEquals("simagoro", ManyToOneOwner.class
            .cast(list.get(1)[0])
        ...
        assertEquals("simagoro", ManyToOneOwner.class
            .cast(list.get(2)[0])
            .getName());
        assertEquals("Personnel", OneToManyInverse.class
            .cast(list.get(2)[1])
            .getName());
        assertEquals("simagoro", ManyToOneOwner.class
            .cast(list.get(3)[0])
            .getName());
        assertEquals("Account", OneToManyInverse.class
            .cast(list.get(3)[1])
            .getName());
        assertEquals("simagoro", ManyToOneOwner.class
            .cast(list.get(4)[0])
            .getName());
        assertEquals("Sales", OneToManyInverse.class
            .cast(list.get(4)[1])
            .getName());
        assertEquals("simagoro", ManyToOneOwner.class
            .cast(list.get(5)[0])
            .getName());
        assertEquals("Purchase", OneToManyInverse.class
            .cast(list.get(5)[1])
            .getName());
    }
        ...
        List<ManyToOneOwner> list =
            selectDistinct("m")
                .from(
                    ...
                    alias(OneToManyInverse.class, "o"))
                .orderby("m.id")
                .getResultList(em);
        assertNotNull(list);
        assertEquals(30, list.size());
    ...
    public void _inner() throws Exception {
        List<ManyToOneOwner> list =
            select("m")
                .from(
                    join(ManyToOneOwner.class, "m").inner(
                        "m.oneToManyInverse",
                        "o"))
                .orderby("m.id")
                .getResultList(em);
    ...
    public void _innerFetch() throws Exception {
        List<ManyToOneOwner> list =
            select("m")
                .from(
                    join(ManyToOneOwner.class, "m").innerFetch(
                        "m.oneToManyInverse"))
                .orderby("m.id")
                .getResultList(em);
        assertNotNull(list);
        ...
        List<ManyToOneOwner> list =
            select("m")
                ...
                .where(
                    ...
                    memberOf("m", "o.subManyToOneOwners"))
                .orderby("m.id")
                .getResultList(em);
        assertNotNull(list);
    ...
    public void _notMemberOf() throws Exception {
        List<ManyToOneOwner> list =
            select("m")
                ...
                .where(
                    eq("o.name", literal("Personnel")),
                    notMemberOf("m", "o.subManyToOneOwners"))
                .orderby("m.id")
                .getResultList(em);
        assertNotNull(list);
    ...
    public void _groupby() throws Exception {
        List<Object[]> list =
            select("o.id", count("m")).from(
                join(ManyToOneOwner.class, "m")
                    .inner("m.oneToManyInverse", "o")).groupby("o.id").orderby(
    ...
    public void havingSingleCondition() throws Exception {
        List<Object[]> list =
            select("m.weight", count("m"))
                .from(ManyToOneOwner.class, "m")
                .groupby("m.weight")
                .having(gt(count("m.weight"), 1))
                .orderby("m.weight")
                .getResultList(em);
        assertNotNull(list);
    ...
    public void havingCompoundCondition() throws Exception {
        List<Object[]> list =
            select("m.weight", count("m"))
                .from(ManyToOneOwner.class, "m")
                .groupby("m.weight")
                .having(and(gt(count("m.weight"), 1), gt(sum("m.weight"), 100)))
                .orderby("m.weight")
                .getResultList(em);
        assertNotNull(list);
        assertEquals(3, list.size());
    ...
    public void whereSingleCondition() throws Exception {
        List<ManyToOneOwner> list =
            select().from(ManyToOneOwner.class).where(
