 ...
 * @author koichik
 */
public class FindAllQueryCommand extends AbstractCommand {
     ...
     * インスタンスを構築します。
     */
    public FindAllQueryCommand(final Class<?> entityClass) {
    ...
    public Object execute(final EntityManager em, final Object[] arguments) {
        return select().from(entityClass).getResultList(em);
    }
